...
# %%
output_code = "02_03_02"

# %%
## Load the alexander streets concpets created by Laura
base_fname = "phrases3_min3_202011217" # phrases2_min2_202011217
df_concepts = pd.read_csv("../input/raw/%s.csv" %base_fname, keep_default_na=False)
...
for text_search_field in dict_text_search_fields_to_df_column:
    ...
    with open("../output/untracked/%s_alex_street_concept_with_dash_to_wiki_pagetitles_of_searched_%s_%s.json" %(output_code,text_search_field,base_fname),"a", encoding="utf-8") as f:     
        for dash_separated_concept in tqdm(alex_street_dash_separated_concepts):
